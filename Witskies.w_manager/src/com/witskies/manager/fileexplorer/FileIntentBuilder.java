...
public class FileIntentBuilder {
	...
	public static void viewFile(final Context context, final String filePath) {
		...
		if (!TextUtils.isEmpty(type) && !TextUtils.equals(type, "*/*")) {
			...
			try {
				...
				ToastUtil.showToast(context, context.getString(R.string.open_info_failed), 1);
			}
			...
			CharSequence[] menuItemArray = new CharSequence[] { context.getString(R.string.dialog_type_text),
					context.getString(R.string.dialog_type_audio), context.getString(R.string.dialog_type_video),
	...
	private static String getMimeType(String filePath) {
		...
		String mimeType = FileMimeUtils.guessMimeTypeFromExtension(ext);
		if (ext.equals("mtz")) {

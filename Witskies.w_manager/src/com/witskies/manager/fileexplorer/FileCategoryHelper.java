...
public class FileCategoryHelper {
	...
	private static String[] DOCUMENT_EXTS = new String[] { "doc", "ppt", "docx", "pptx", "xsl", "xslx", "txt", "log", "pdf", "ini", "lrc" };
	private static String[] ZIP_EXTS = new String[] { "zip", "rar" };
	private static String[] VIDEO_EXTS = new String[] { "mp4", "wmv", "mpeg", "m4v", "3gp", "3gpp", "3g2", "3gpp2", "asf" };

	private static String[] PICTURE_EXTS = new String[] { "jpg", "jpeg", "gif", "png", "bmp", "wbmp" };
